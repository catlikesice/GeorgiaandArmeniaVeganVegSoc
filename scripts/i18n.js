...
const translations = {
  en: {
    ...
    "index.nav.membershipBusiness": `Business Membership`,
    "index.nav.membershipIndividual": `Individual Membership`,
  ...
  ru: {
    ...
    "index.nav.membershipBusiness": `Корпоративное членство`,
    "index.nav.membershipIndividual": `Индивидуальное членство`,
  ...
  ka: {
    ...
    "index.nav.membershipBusiness": `ბიზნეს წევრობა`,
    "index.nav.membershipIndividual": `ინდივიდუალური წევრობა`,
  ...
  hy: {
    ...
    "index.nav.membershipBusiness": `Բիզնես անդամակցություն`,
    "index.nav.membershipIndividual": `Անհատական անդամակցություն`,
